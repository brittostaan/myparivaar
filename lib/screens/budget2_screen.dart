...
class Budget2Screen extends StatefulWidget {
  const Budget2Screen({super.key});

  @override
  State<Budget2Screen> createState() => _Budget2ScreenState();
}
...
class _Budget2ScreenState extends State<Budget2Screen> {
  ...
  // Sort & Group controls
  bool _budgetSortAscending = false;
  String _budgetGroupBy = 'none'; // 'none', 'category', 'tag'
    ...
    return [
      ...
      PopupMenuButton<String?>(
        ...
        icon: Icon(
          ...
          color: hasCatFilter ? const Color(0xFF3B82F6) : const Color(0xFF64748B),
          size: 20,
        ),
      ...
      Tooltip(
        ...
        child: IconButton(
          icon: Icon(
            ...
            color: (_showCalendarDropdown || hasDateFilter) ? const Color(0xFF3B82F6) : const Color(0xFF64748B),
            size: 20,
          ),
          onPressed: () => setState(() {
      ...
      Tooltip(
        ...
        child: IconButton(
          icon: Icon(
            Icons.add_rounded,
            color: _showInlineBudgetForm ? const Color(0xFF3B82F6) : const Color(0xFF64748B),
            size: 20,
          ),
          onPressed: () {
  ...
  Widget _buildRewardsRow(bool isDark) {
    final rewards = <_BudgetRewardIcon>[
      _BudgetRewardIcon(Icons.emoji_events_rounded, const Color(0xFFFBBF24), 'Budget Champion'), // amber-400
      _BudgetRewardIcon(Icons.savings_rounded, const Color(0xFF34D399), 'Smart Saver'), // emerald-400
      _BudgetRewardIcon(Icons.auto_graph_rounded, const Color(0xFF60A5FA), 'Trend Watcher'), // blue-400
      _BudgetRewardIcon(Icons.favorite_rounded, const Color(0xFFFB7185), 'Impulse Control'), // rose-400
      _BudgetRewardIcon(Icons.shield_rounded, const Color(0xFFC084FC), 'No Leaks'), // purple-400
      _BudgetRewardIcon(Icons.star_rounded, const Color(0xFFFB923C), 'Consistent'), // orange-400
      _BudgetRewardIcon(Icons.diamond_rounded, const Color(0xFF22D3EE), 'Goal Achiever'), // cyan-400
    ];
  ...
  Widget _buildInfoCardsList(bool isDark, Color primary) {
    ...
    final allCards = <Widget>[
      _aiCard('💧', 'Spend Leakage',
          ...
          leakyBudgets.isNotEmpty ? const Color(0xFFF43F5E) : const Color(0xFF10B981), // rose-500 / emerald-500
      ...
      _aiCard('⚡', 'Impulse Risk',
          ...
          hasImpulseRisk ? const Color(0xFFF97316) : const Color(0xFF10B981), // orange-500 / emerald-500
      ...
      _aiCard('🔔', 'Recurring Lock-in',
          ...
          recurringTotal > 0 ? const Color(0xFFF43F5E) : const Color(0xFF10B981), // rose-500 / emerald-500
      ...
      _aiCard('🔍', 'Silent Erosion',
          ...
          smallBudgets.isNotEmpty ? const Color(0xFF818CF8) : const Color(0xFF10B981), // indigo-400 / emerald-500
      ...
      _aiCard('📉', 'Slippage',
          ...
          slippageCat != null ? const Color(0xFFF43F5E) : const Color(0xFF22C55E), // rose-500 / green-500
      ...
      _aiCard('📊', 'Instability',
          ...
          maxFluctuation > 20 ? const Color(0xFFFBBF24) : const Color(0xFF10B981), // amber-400 / emerald-500
          maxFluctuation > 20 ? 'Stabilize' : 'Stable'),

      _aiCard('✅', 'Healthy Mix',
          '${mixRatio.toStringAsFixed(0)}% of budget allocated to essentials & long-term needs.',
          mixRatio >= 60 ? const Color(0xFF10B981) : const Color(0xFFF97316), // emerald-500 / orange-500
      ...
      _aiCard('🏆', 'Discipline Score',
          ...
          disciplineScore >= 7 ? const Color(0xFF10B981) : disciplineScore >= 4 ? const Color(0xFFFBBF24) : const Color(0xFFF43F5E), // emerald-500 / amber-400 / rose-500
      ...
      _aiCard('💳', 'Safe-to-Spend',
          ...
          remaining > 0 ? const Color(0xFF10B981) : const Color(0xFFF43F5E), // emerald-500 / rose-500
      ...
      _aiCard('📐', 'Income Fit',
          ...
          usagePct <= 85 ? const Color(0xFF22C55E) : const Color(0xFFF97316), // green-500 / orange-500
      ...
      _aiCard('⚖️', 'Fixed vs Flexible Split',
          ...
          fixedPct <= 65 ? const Color(0xFF10B981) : const Color(0xFFF97316), // emerald-500 / orange-500
      ...
      _aiCard('🛡️', 'Emergency Buffer Health',
          ...
          emergencyBudget > 0 ? const Color(0xFF10B981) : const Color(0xFFF43F5E), // emerald-500 / rose-500
      ...
      _aiCard('🎯', 'Goal Impact',
          ...
          savingsBudget > 0 ? const Color(0xFF22C55E) : const Color(0xFFFBBF24), // green-500 / amber-400
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(message, style: TextStyle(fontSize: 10, color: const Color(0xFF64748B), height: 1.3)), // slate-500
              ],
            ),
          ),
        ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF6B21A8), Color(0xFF4F46E5)], // purple-700, indigo-600
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(16),
        boxShadow: [BoxShadow(color: const Color(0xFF6B21A8).withOpacity(0.2), blurRadius: 12, offset: const Offset(0, 4))],
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
  ...
  List<Budget> get _filteredBudgets {
    var list = _selectedCategoryFilter == null
        ? [..._budgets]
        : _budgets.where((b) => _budgetMatchesCategory(b, _selectedCategoryFilter!.toLowerCase())).toList();
    // Apply sort
    list.sort((a, b) => _budgetSortAscending
        ? a.amount.compareTo(b.amount)
        : b.amount.compareTo(a.amount));
    return list;
  }

  Map<String, List<Budget>> get _groupedBudgets {
    final filtered = _filteredBudgets;
    if (_budgetGroupBy == 'none') return {'': filtered};
    final map = <String, List<Budget>>{};
    for (final b in filtered) {
      final key = _budgetGroupBy == 'category'
          ? _titleCase(b.category)
          : b.tags.isNotEmpty ? b.tags.first : 'Untagged';
      (map[key] ??= []).add(b);
    }
    return map;
  }
  ...
  Widget _buildBudgetListControls() {
    final hasDateFilter = _filterStartDate != null || _filterEndDate != null;
    final hasCatFilter = _selectedCategoryFilter != null;
    ...
    return Row(
      ...
      children: [
        ...
        // 2. Group By
        PopupMenuButton<String>(
          tooltip: _budgetGroupBy == 'none' ? 'Group By' : 'Grouped: ${_titleCase(_budgetGroupBy)}',
          icon: Icon(Icons.workspaces_outlined, color: _budgetGroupBy != 'none' ? activeColor : iconColor, size: iconSize),
          constraints: btnConstraints,
          padding: EdgeInsets.zero,
          onSelected: (value) => setState(() => _budgetGroupBy = value),
          itemBuilder: (context) => [
            PopupMenuItem(value: 'none', child: Row(children: [
              if (_budgetGroupBy == 'none') const Icon(Icons.check_rounded, size: 16, color: activeColor) else const SizedBox(width: 16),
              const SizedBox(width: 8),
              const Text('No Grouping', style: TextStyle(fontSize: 13)),
            ])),
            PopupMenuItem(value: 'category', child: Row(children: [
              if (_budgetGroupBy == 'category') const Icon(Icons.check_rounded, size: 16, color: activeColor) else const SizedBox(width: 16),
              const SizedBox(width: 8),
              const Text('By Category', style: TextStyle(fontSize: 13)),
            ])),
            PopupMenuItem(value: 'tag', child: Row(children: [
              if (_budgetGroupBy == 'tag') const Icon(Icons.check_rounded, size: 16, color: activeColor) else const SizedBox(width: 16),
              const SizedBox(width: 8),
              const Text('By Tag', style: TextStyle(fontSize: 13)),
            ])),
          ],
        ),
        // 3. Sort by Amount
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => setState(() => _budgetSortAscending = !_budgetSortAscending),
            constraints: btnConstraints,
            padding: EdgeInsets.zero,
            splashRadius: 18,
          ),
        ...
        Tooltip(
          message: 'Add Budget',
          child: IconButton(
            icon: Icon(Icons.add_rounded, color: _showInlineBudgetForm ? activeColor : iconColor, size: iconSize),
            onPressed: () {
              if (_showInlineBudgetForm) { _closeBudgetForm(); } else { _openBudgetForm(); }
            },
            constraints: btnConstraints,
            padding: EdgeInsets.zero,
            splashRadius: 18,
  ...
  Widget _buildWebBudgetList(BudgetSummary summary, bool isDark, Color primary) {
    final filtered = _filteredBudgets;
    final controls = _buildBudgetListControls();
      ...
      return Stack(
        ...
        children: [
          ...
          if (_showCalendarDropdown)
            Positioned(
              top: 48, right: 8,
              child: Material(elevation: 8, borderRadius: BorderRadius.circular(16), child: _buildInlineCalendar()),
            ),
        ],
      );
    }
    ...
    final showGroupHeaders = _budgetGroupBy != 'none';
                    ...
                    Row(
                      children: [
                        Text('Budget vs Expense',
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF1E293B))), // slate-800
                        const SizedBox(width: 8),
                        Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      for (final entry in grouped.entries) ...[
                        ...
                        ...entry.value.map((budget) => _buildWebBudgetRow(budget, isDark, primary)),
                      ],
                    ],
                  ),
                ),
                    ...
                    children: [
                      ...
                      if (budget.tags.isNotEmpty) ...[
                        ...
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                          decoration: BoxDecoration(
                            color: const Color(0xFFC084FC).withOpacity(0.08), // purple-400
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Text(
                            budget.tags.take(2).join(', '),
                            style: TextStyle(fontSize: 9, fontWeight: FontWeight.w600, color: const Color(0xFFC084FC)), // purple-400
                          ),
                        ),
                      ],
                    ],
  ...
  Color _budgetCategoryColor(String category) {
    switch (category.toLowerCase()) {
      case 'food': return const Color(0xFF34D399); // emerald-400
      case 'groceries': case 'grocery': return const Color(0xFF34D399); // emerald-400
      case 'shopping': return const Color(0xFFF472B6); // pink-400
      case 'utilities': return const Color(0xFF818CF8); // indigo-400
      case 'transport': return const Color(0xFF22D3EE); // cyan-400
      case 'entertainment': return const Color(0xFFFB923C); // orange-400
      case 'healthcare': return const Color(0xFF22D3EE); // cyan-400
      case 'education': return const Color(0xFFFB7185); // rose-400
      case 'party': return const Color(0xFFFB923C); // orange-400
      case 'vacation': case 'travel': return const Color(0xFF22D3EE); // cyan-400
      case 'bank': return const Color(0xFFFBBF24); // amber-400
      case 'other': return const Color(0xFF34D399); // emerald-400
      default: return const Color(0xFF818CF8); // indigo-400
    }
  }
        ...
        child: Row(
          children: [
            Icon(
              icon,
              size: 15,
              color: active ? const Color(0xFF3B82F6) : null,
            ),
            const SizedBox(width: 6),
            Text(
              label,
  ...
  Widget _buildAIInsightsCard(bool isDark, Color primary) {
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFFFAF5FF), const Color(0xFFEFF6FF)], // purple-50, blue-50
        ),
        borderRadius: BorderRadius.circular(18),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.auto_awesome, color: const Color(0xFF6B21A8), size: 22), // purple-700
              const SizedBox(width: 8),
              const Text(
                'AI Budget Insights',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B)), // slate-800
              ),
              const Spacer(),
              if (_isLoadingInsights)
                ...
                FilledButton.icon(
                  ...
                  style: FilledButton.styleFrom(
                    backgroundColor: const Color(0xFF6B21A8), // purple-700
          ...
          if (_aiSuggestions.isNotEmpty) ...[
            ...
            ..._aiSuggestions.map((s) => Padding(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.lightbulb_outline, size: 16, color: const Color(0xFFFBBF24)), // amber-400
                      const SizedBox(width: 8),
          ...
          children: [
            ...
            if (_isCategorizingWithAI)
              Padding(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Text('AI is categorizing items...', style: TextStyle(fontSize: 11, color: const Color(0xFFC084FC), fontWeight: FontWeight.w600)),
                ]),
              ),
            if (_aiCategorizationDone)
              Padding(
                padding: const EdgeInsets.only(top: 6),
                child: Row(children: [
                  Icon(Icons.auto_awesome, size: 14, color: const Color(0xFFC084FC)),
                  const SizedBox(width: 6),
                  Text('AI categorized. Review & correct if needed.', style: TextStyle(fontSize: 11, color: const Color(0xFFC084FC), fontWeight: FontWeight.w600)),
                ]),
              ),
            if (_aiError != null)
              Padding(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.auto_awesome, size: 20, color: Color(0xFF6B21A8)),
              const SizedBox(width: 8),
              const Text('AI Insights', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
              const Spacer(),
              IconButton(
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [const Color(0xFFFAF5FF), const Color(0xFFEFF6FF)]), // purple-50, blue-50
              borderRadius: BorderRadius.circular(10),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    Icon(Icons.analytics_outlined, size: 16, color: const Color(0xFF6B21A8)),
                    const SizedBox(width: 6),
                    Text('Budget Analysis', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: const Color(0xFF6B21A8))),
                  ],
                ),
                const SizedBox(height: 8),
                if (_loading)
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.chat_bubble_outline, size: 16, color: const Color(0xFFC084FC)),
                    const SizedBox(width: 6),
                    Text('Ask AI', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: const Color(0xFF6B21A8))),
                  ],
                ),
                const SizedBox(height: 8),
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          return Align(
                            ...
                            child: Container(
                              ...
                              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                              decoration: BoxDecoration(
                                color: msg.isUser ? const Color(0xFFF3E8FF) : Colors.white, // purple-100
                                borderRadius: BorderRadius.circular(12),
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: Icon(Icons.send_rounded, color: const Color(0xFF4F46E5)), // indigo-600
                      tooltip: 'Send',
                    ),
                  ],
                ),
                  ...
                  children: [
                    Expanded(
                      child: _quickPromptCard(
                        ...
                        color: const Color(0xFF6B21A8), // purple-700
